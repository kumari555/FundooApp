                        ...
                        <AppBar className="dashboard-appbar">
                            <MuiThemeProvider theme={theme}>
                                <Toolbar>
                                    ...
                                    <Tooltip title="refreash">
                                        <RefreshOutlinedIcon className="refreshIcon" style={{ padding: "1px 1px 1px 19px" }}
                                            onClick={this.handleRefreash} /></Tooltip>
                                    {!this.state.listOpen ?
                                        <Tooltip title="List view">
                                            <ViewAgendaOutlinedIcon style={{ padding: "1px 1px 1px 19px" }}
                                                onClick={this.handleListIcon}
                                            /></Tooltip>
                                        : <Tooltip title="List view"><GridOnIcon onClick={this.handleGridIcon} /></Tooltip>}
                                    <div>
